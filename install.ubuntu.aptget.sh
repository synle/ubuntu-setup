...
git -v &> /dev/null || sudo apt-get install  -y --fix-missing git;
vim -v &> /dev/null || sudo apt-get install  -y --fix-missing vim;
curl -v &> /dev/null || sudo apt-get install  -y --fix-missing curl;
